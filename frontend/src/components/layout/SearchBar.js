const SearchBar = (props) => {
    ...
    return (
        <div className="relative flex-grow inline-block p-0 mt-1 mr-1 bg-white rounded shadow-lg sm:mr-3">
            ...
            <label
                htmlFor="query"
                className="absolute z-10 inline-block text-xs left-1.5 text-gray-500 duration-300 sm:text-sm top-1/2 transform -translate-y-1/2 tracking-tighter origin-0 md:left-3 md:text-base focus:outline-none"
            >
