const InputBox = (props) => {
    ...
    return (
        <>
            ...
            <label
                htmlFor={props.name}
                className="absolute z-10 inline-block tracking-tighter text-gray-500 duration-300 transform -translate-y-1/2 left-3 top-1/2 origin-0 md:text-base focus:outline-none"
            >
                {props.children}
            </label>
        </>
